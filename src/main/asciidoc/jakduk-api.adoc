...
.request headers
include::{snippets}/getMySessionUser/request-headers.adoc[]
.http request
include::{snippets}/getMySessionUser/http-request.adoc[]
.curl request
include::{snippets}/getMySessionUser/curl-request.adoc[]

.response fields
include::{snippets}/getMySessionUser/response-fields.adoc[]
.http response
include::{snippets}/getMySessionUser/http-response.adoc[]
