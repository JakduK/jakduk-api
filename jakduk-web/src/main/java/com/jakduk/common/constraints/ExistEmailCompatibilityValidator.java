...
public class ExistEmailCompatibilityValidator implements ConstraintValidator<ExistEmailCompatibility, Object> {
    ...
    public void initialize(ExistEmailCompatibility constraintAnnotation) {
        userIdName = constraintAnnotation.userId();
        emailName = constraintAnnotation.email();
    }
    ...
    public boolean isValid(Object value, ConstraintValidatorContext context) {
        ...
        try {
            final String userId = BeanUtils.getProperty(value, userIdName);
            final String email = BeanUtils.getProperty(value, emailName);
