...
<body class="header-fixed">
    ...
    <div class="wrapper" ng-controller="oauthCtrl">
        <jsp:include page="../include/navigation-header.jsp"/>

        <!--=== Breadcrumbs ===-->
        <div class="breadcrumbs">
            <div class="container">
                <h1 class="pull-left"><a href="<c:url value="/social/user/refresh"/>"><spring:message code="user.profile"/></a></h1>
            </div><!--/container-->
        </div><!--/breadcrumbs-->
        <!--=== End Breadcrumbs ===-->
    ...
    <script type="text/javascript">
        ...
        jakdukApp.controller("oauthCtrl", function($scope) {
